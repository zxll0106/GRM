...
class Config(object):
    ...
    def __init__(self, dataset_name):
        ...
        if dataset_name=='volleyball':
            self.data_path = '/extend/zxl/Group_Activity_Recognition/dataset/volleyball/videos/' #data path for the volleyball dataset
            ...
            self.data_path='/extend/zxl/Group_Activity_Recognition/dataset/collective activity/Collective Activity/data/ActivityDataset/'  #data path for the collective dataset
    ...
    def init_config(self, need_new_folder=True):
        ...
        self.result_path='/extend/zxl/Group_Activity_Prediction/DIN-Group-Activity-Recognition-Benchmark-main-ablation/result/%s'%self.exp_name
        self.log_path='/extend/zxl/Group_Activity_Prediction/DIN-Group-Activity-Recognition-Benchmark-main-ablation/result/%s/log.txt'%self.exp_name
